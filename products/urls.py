...
urlpatterns = [
    ...
    path('update-category/<uuid:id>', views.CategoryUpdateView.as_view(), name="category_update_view"),
    ...
    path('update-product/<uuid:id>', views.ProductUpdateView.as_view(), name="product_update_view"),
    ...
    path('update-photo/<uuid:id>', views.PhotoUpdateView.as_view(), name="photo_update_view"),
